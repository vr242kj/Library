...
public class UserInterface {
        ...
        while (true) {
            ...
            try {
                switch (input.nextLine()) {
                    case "1" -> printAllItemsInCollection(libraryService.printAllBooks());
                    case "2" -> printAllItemsInCollection(libraryService.printAllReaders());
                    case "3" -> {
                    ...
                    case "5" -> {
                        ...
                        printMapBookToReader(libraryService.borrowBookToReader(inputBookIDAndAuthorID));
                    }
                    case "6" -> {
    ...
    public <T> void printAllItemsInCollection (List<T> data) {
    ...
    public void printMapBookToReader(HashMap<Long, Long> bookAndReader) {
