...
SELECT 'Gabriel Garcia Marquez' WHERE NOT EXISTS (SELECT 1 FROM reader WHERE name = 'Gabriel Garcia Marquez');
INSERT INTO reader(name)
SELECT 'F. Scott Fitzgerald' WHERE NOT EXISTS (SELECT 1 FROM reader WHERE name = 'F. Scott Fitzgerald');
INSERT INTO reader(name)
